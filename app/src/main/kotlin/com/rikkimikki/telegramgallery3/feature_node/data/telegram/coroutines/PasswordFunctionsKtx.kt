 ...
 */
suspend fun TelegramFlow.recoverAuthenticationPassword(recoveryCode: String?,newPassword: String?,newHint: String?) =
 ...
 * @return [PasswordState] Represents the current state of 2-step verification.
 */
suspend fun TelegramFlow.recoverPassword(recoveryCode: String?,newPassword: String?,newHint: String?): PasswordState =
    this.sendFunctionAsync(TdApi.RecoverPassword(recoveryCode,newPassword,newHint))
