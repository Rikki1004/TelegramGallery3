...
): Message = this.sendFunctionAsync(TdApi.AddLocalMessage(chatId, MessageSenderUser(senderUserId), replyToMessageId,
...
suspend fun TelegramFlow.getMessageLink(chatId: Long, messageId: Long): HttpUrl =
    this.sendFunctionAsync(TdApi.GetMessageLink(chatId, messageId,0,false,false))
...
//  messageId: Long,
//  forAlbum: Boolean
//): PublicMessageLink = this.sendFunctionAsync(TdApi.GetMessageLink(chatId, messageId,
//    forAlbum))
...
suspend fun TelegramFlow.searchMessages(
  ...
  filter: SearchMessagesFilter
    ...
    offsetMessageId, limit,filter,0,0))
...
suspend fun TelegramFlow.searchSecretMessages(
  ...
  limit: Int,
  filter: SearchMessagesFilter?
): FoundMessages = this.sendFunctionAsync(TdApi.SearchSecretMessages(chatId, query, offset,
    limit, filter))
...
suspend fun TelegramFlow.sendMessage(
    ...
    replyMarkup: ReplyMarkup?,
    inputMessageContent: InputMessageContent?
): Message = this.sendFunctionAsync(TdApi.SendMessage(chatId, threadMessageId,0, options,
...
): Messages = this.sendFunctionAsync(TdApi.SendMessageAlbum(chatId, replyToMessageId,0, options,
...
suspend fun TelegramFlow.viewMessages(
  ...
  messageIds: LongArray?,
  forceRead: Boolean
) = this.sendFunctionLaunch(TdApi.ViewMessages(chatId,0, messageIds, forceRead))
