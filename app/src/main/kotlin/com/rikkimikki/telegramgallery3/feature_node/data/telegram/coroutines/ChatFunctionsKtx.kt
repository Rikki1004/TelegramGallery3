...
//    this.sendFunctionAsync(TdApi.ChatInviteLink(chatId))
 ...
 */
suspend fun TelegramFlow.getChatMember(chatId: Long, userId: Long): ChatMember =
    this.sendFunctionAsync(TdApi.GetChatMember(chatId, TdApi.MessageSenderChat (userId)))
...
suspend fun TelegramFlow.getChats(
  chatList: ChatList?,
  limit: Int
): Chats = this.sendFunctionAsync(TdApi.GetChats(chatList, limit))

suspend fun TelegramFlow.loadChats(
    chatList: ChatList?,
    limit: Int
): TdApi.Object = this.sendFunctionAsync(TdApi.LoadChats(chatList, limit))
/**
...
) = this.sendFunctionLaunch(TdApi.PinChatMessage(chatId, messageId, disableNotification,false))
...
suspend fun TelegramFlow.searchChatMessages(
  ...
  limit: Int,
  filter: SearchMessagesFilter?
): Messages = this.sendFunctionAsync(TdApi.SearchChatMessages(chatId, query, TdApi.MessageSenderChat(senderUserId),
    fromMessageId, offset, limit, filter,0))
...
suspend fun TelegramFlow.sendChatAction(chatId: Long, action: ChatAction) =
    this.sendFunctionLaunch(TdApi.SendChatAction(chatId,0, action))
...
//    this.sendFunctionLaunch(TdApi.SetChat .SetChatChatList(chatId, chatList))
...
suspend fun TelegramFlow.setChatDraftMessage(chatId: Long, draftMessage: DraftMessage? = null) =
    this.sendFunctionLaunch(TdApi.SetChatDraftMessage(chatId,0, draftMessage))
...
) = this.sendFunctionLaunch(TdApi.SetChatMemberStatus(chatId, MessageSenderChat(userId), status))
 ...
 */
suspend fun TelegramFlow.toggleChatIsPinned(chatList: ChatList,chatId: Long, isPinned: Boolean) =
 ...
 * @param chatId Identifier of the chat.
 */
suspend fun TelegramFlow.unpinChatMessage(chatId: Long,msgId:Long) =
    this.sendFunctionLaunch(TdApi.UnpinChatMessage(chatId,msgId))
