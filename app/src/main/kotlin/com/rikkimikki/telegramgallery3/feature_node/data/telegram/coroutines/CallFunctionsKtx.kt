 ...
 */
suspend fun TelegramFlow.createCall(userId: Long, protocol: CallProtocol?): CallId =
    this.sendFunctionAsync(TdApi.CreateCall(userId, protocol,false))
...
suspend fun TelegramFlow.discardCall(
  ...
  duration: Int,
  connectionId: Long
) = this.sendFunctionLaunch(TdApi.DiscardCall(callId, isDisconnected, duration,false, connectionId))
