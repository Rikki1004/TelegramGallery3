...
import com.rikkimikki.telegramgallery3.feature_node.data.telegram.coroutines.addChatMember
import com.rikkimikki.telegramgallery3.feature_node.data.telegram.coroutines.addChatMembers
import com.rikkimikki.telegramgallery3.feature_node.data.telegram.coroutines.addLocalMessage
import com.rikkimikki.telegramgallery3.feature_node.data.telegram.coroutines.addRecentlyFoundChat
import com.rikkimikki.telegramgallery3.feature_node.data.telegram.coroutines.checkChatUsername
import com.rikkimikki.telegramgallery3.feature_node.data.telegram.coroutines.closeChat
import com.rikkimikki.telegramgallery3.feature_node.data.telegram.coroutines.deleteChatHistory
import com.rikkimikki.telegramgallery3.feature_node.data.telegram.coroutines.deleteChatReplyMarkup
import com.rikkimikki.telegramgallery3.feature_node.data.telegram.coroutines.deleteMessages
import com.rikkimikki.telegramgallery3.feature_node.data.telegram.coroutines.editMessageCaption
import com.rikkimikki.telegramgallery3.feature_node.data.telegram.coroutines.editMessageLiveLocation
import com.rikkimikki.telegramgallery3.feature_node.data.telegram.coroutines.editMessageMedia
import com.rikkimikki.telegramgallery3.feature_node.data.telegram.coroutines.editMessageReplyMarkup
import com.rikkimikki.telegramgallery3.feature_node.data.telegram.coroutines.editMessageSchedulingState
import com.rikkimikki.telegramgallery3.feature_node.data.telegram.coroutines.editMessageText
import com.rikkimikki.telegramgallery3.feature_node.data.telegram.coroutines.forwardMessages
import com.rikkimikki.telegramgallery3.feature_node.data.telegram.coroutines.getCallbackQueryAnswer
import com.rikkimikki.telegramgallery3.feature_node.data.telegram.coroutines.getChat
import com.rikkimikki.telegramgallery3.feature_node.data.telegram.coroutines.getChatAdministrators
import com.rikkimikki.telegramgallery3.feature_node.data.telegram.coroutines.getChatEventLog
import com.rikkimikki.telegramgallery3.feature_node.data.telegram.coroutines.getChatHistory
import com.rikkimikki.telegramgallery3.feature_node.data.telegram.coroutines.getChatMember
import com.rikkimikki.telegramgallery3.feature_node.data.telegram.coroutines.getChatMessageByDate
import com.rikkimikki.telegramgallery3.feature_node.data.telegram.coroutines.getChatMessageCount
import com.rikkimikki.telegramgallery3.feature_node.data.telegram.coroutines.getChatPinnedMessage
import com.rikkimikki.telegramgallery3.feature_node.data.telegram.coroutines.getChatScheduledMessages
import com.rikkimikki.telegramgallery3.feature_node.data.telegram.coroutines.getGameHighScores
import com.rikkimikki.telegramgallery3.feature_node.data.telegram.coroutines.getInlineQueryResults
import com.rikkimikki.telegramgallery3.feature_node.data.telegram.coroutines.getLoginUrl
import com.rikkimikki.telegramgallery3.feature_node.data.telegram.coroutines.getLoginUrlInfo
import com.rikkimikki.telegramgallery3.feature_node.data.telegram.coroutines.getMapThumbnailFile
import com.rikkimikki.telegramgallery3.feature_node.data.telegram.coroutines.getMessage
import com.rikkimikki.telegramgallery3.feature_node.data.telegram.coroutines.getMessageLink
import com.rikkimikki.telegramgallery3.feature_node.data.telegram.coroutines.getMessageLocally
import com.rikkimikki.telegramgallery3.feature_node.data.telegram.coroutines.getMessages
import com.rikkimikki.telegramgallery3.feature_node.data.telegram.coroutines.getPaymentForm
import com.rikkimikki.telegramgallery3.feature_node.data.telegram.coroutines.getPaymentReceipt
import com.rikkimikki.telegramgallery3.feature_node.data.telegram.coroutines.getPollVoters
import com.rikkimikki.telegramgallery3.feature_node.data.telegram.coroutines.getRepliedMessage
import com.rikkimikki.telegramgallery3.feature_node.data.telegram.coroutines.joinChat
import com.rikkimikki.telegramgallery3.feature_node.data.telegram.coroutines.leaveChat
import com.rikkimikki.telegramgallery3.feature_node.data.telegram.coroutines.openChat
import com.rikkimikki.telegramgallery3.feature_node.data.telegram.coroutines.openMessageContent
import com.rikkimikki.telegramgallery3.feature_node.data.telegram.coroutines.pinChatMessage
import com.rikkimikki.telegramgallery3.feature_node.data.telegram.coroutines.readAllChatMentions
import com.rikkimikki.telegramgallery3.feature_node.data.telegram.coroutines.removeChatActionBar
import com.rikkimikki.telegramgallery3.feature_node.data.telegram.coroutines.removeRecentlyFoundChat
import com.rikkimikki.telegramgallery3.feature_node.data.telegram.coroutines.removeTopChat
import com.rikkimikki.telegramgallery3.feature_node.data.telegram.coroutines.resendMessages
import com.rikkimikki.telegramgallery3.feature_node.data.telegram.coroutines.saveApplicationLogEvent
import com.rikkimikki.telegramgallery3.feature_node.data.telegram.coroutines.searchChatMembers
import com.rikkimikki.telegramgallery3.feature_node.data.telegram.coroutines.searchChatMessages
import com.rikkimikki.telegramgallery3.feature_node.data.telegram.coroutines.searchChatRecentLocationMessages
import com.rikkimikki.telegramgallery3.feature_node.data.telegram.coroutines.searchSecretMessages
import com.rikkimikki.telegramgallery3.feature_node.data.telegram.coroutines.sendBotStartMessage
import com.rikkimikki.telegramgallery3.feature_node.data.telegram.coroutines.sendChatAction
import com.rikkimikki.telegramgallery3.feature_node.data.telegram.coroutines.sendChatScreenshotTakenNotification
import com.rikkimikki.telegramgallery3.feature_node.data.telegram.coroutines.sendChatSetTtlMessage
import com.rikkimikki.telegramgallery3.feature_node.data.telegram.coroutines.sendInlineQueryResultMessage
import com.rikkimikki.telegramgallery3.feature_node.data.telegram.coroutines.sendMessage
import com.rikkimikki.telegramgallery3.feature_node.data.telegram.coroutines.sendMessageAlbum
import com.rikkimikki.telegramgallery3.feature_node.data.telegram.coroutines.setChatClientData
import com.rikkimikki.telegramgallery3.feature_node.data.telegram.coroutines.setChatDescription
import com.rikkimikki.telegramgallery3.feature_node.data.telegram.coroutines.setChatDiscussionGroup
import com.rikkimikki.telegramgallery3.feature_node.data.telegram.coroutines.setChatDraftMessage
import com.rikkimikki.telegramgallery3.feature_node.data.telegram.coroutines.setChatLocation
import com.rikkimikki.telegramgallery3.feature_node.data.telegram.coroutines.setChatMemberStatus
import com.rikkimikki.telegramgallery3.feature_node.data.telegram.coroutines.setChatNotificationSettings
import com.rikkimikki.telegramgallery3.feature_node.data.telegram.coroutines.setChatPermissions
import com.rikkimikki.telegramgallery3.feature_node.data.telegram.coroutines.setChatPhoto
import com.rikkimikki.telegramgallery3.feature_node.data.telegram.coroutines.setChatSlowModeDelay
import com.rikkimikki.telegramgallery3.feature_node.data.telegram.coroutines.setChatTitle
import com.rikkimikki.telegramgallery3.feature_node.data.telegram.coroutines.setGameScore
import com.rikkimikki.telegramgallery3.feature_node.data.telegram.coroutines.setPollAnswer
import com.rikkimikki.telegramgallery3.feature_node.data.telegram.coroutines.stopPoll
import com.rikkimikki.telegramgallery3.feature_node.data.telegram.coroutines.toggleChatDefaultDisableNotification
import com.rikkimikki.telegramgallery3.feature_node.data.telegram.coroutines.toggleChatIsMarkedAsUnread
import com.rikkimikki.telegramgallery3.feature_node.data.telegram.coroutines.toggleChatIsPinned
import com.rikkimikki.telegramgallery3.feature_node.data.telegram.coroutines.transferChatOwnership
import com.rikkimikki.telegramgallery3.feature_node.data.telegram.coroutines.unpinChatMessage
import com.rikkimikki.telegramgallery3.feature_node.data.telegram.coroutines.upgradeBasicGroupChatToSupergroupChat
import com.rikkimikki.telegramgallery3.feature_node.data.telegram.coroutines.validateOrderInfo
import com.rikkimikki.telegramgallery3.feature_node.data.telegram.coroutines.viewMessages
...
interface ChatKtx : BaseKtx {
   ...
   */
  //suspend fun Chat.generateInviteLink() = api.link.generateChatInviteLink(this.id)
   ...
   */
  suspend fun Chat.getMember(userId: Long) = api.getChatMember(this.id, userId)
   ...
   */
  //suspend fun Chat.setList(chatList: ChatList?) = api.setChat .setChatChatList(this.id, chatList)
   ...
   */
  suspend fun Chat.setMemberStatus(userId: Long, status: ChatMemberStatus?) =
   ...
   */
  suspend fun Chat.toggleIsPinned(chatList:ChatList, isPinned: Boolean) = api.toggleChatIsPinned(chatList,this.id, isPinned)
