...
import org.drinkless.td.libcore.telegram.TdApi.ChatPhoto
...
suspend fun TelegramFlow.getUserProfilePhotos(
  ...
  offset: Int,
  limit: Int
): ChatPhoto = this.sendFunctionAsync(TdApi.GetUserProfilePhotos(userId, offset, limit))
 ...
 * @param userId User identifier.
 */
//suspend fun TelegramFlow.unblockUser(userId: Long) =
