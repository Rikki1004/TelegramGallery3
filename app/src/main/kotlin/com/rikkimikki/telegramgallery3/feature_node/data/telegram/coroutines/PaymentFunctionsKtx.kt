...
suspend fun TelegramFlow.getPaymentForm(chatId: Long, messageId: Long): PaymentForm =
    this.sendFunctionAsync(TdApi.GetPaymentForm(chatId, messageId,TdApi.PaymentFormTheme()))
...
): PaymentResult = this.sendFunctionAsync(TdApi.SendPaymentForm(chatId, messageId,0, orderInfoId,
    shippingOptionId, credentials,0))
*/
