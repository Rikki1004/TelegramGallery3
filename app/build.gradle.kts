...
android {
    ...
    buildTypes {
        getByName("debug") {
            ...
            manifestPlaceholders["appProvider"] = "com.rikkimikki.telegramgallery3.debug.media_provider"
            buildConfigField(
                "String",
                "CONTENT_AUTHORITY",
        ...
        getByName("release") {
            manifestPlaceholders += mapOf(
                "appProvider" to "com.rikkimikki.telegramgallery3.media_provider"
            )
            ...
            buildConfigField("String", "MAPS_TOKEN", getApiKey())
            buildConfigField("String", "CONTENT_AUTHORITY", "\"com.rikkimikki.telegramgallery3.media_provider\"")
        }
        create("staging") {
